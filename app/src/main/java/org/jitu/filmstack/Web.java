...
public class Web extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = ProgressDialog.show(Web.this, "", "Loading...");
        ...
        wv1.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                progressBar.cancel();
                String username = "jk26111996@gmail.com";
                String password = "jitu2611" ;
                /*view.loadUrl("javascript: {" +
                        "document.getElementByName('frm-signInForm-email').value = '"+username +"';" +
                        " document.getElementById('frm-signInForm-password').value = '"+password+"';" +
                        "var z = document.getElementById('submit').click(); } ;" ) ;
               */

                if(count==1) {
                    count++ ;
                    view.loadUrl("javascript: var x = document.getElementById('body-login-button-new').click() ;");
                    view.loadUrl("javascript: var y = document.getElementsByTagName('INPUT')[42].value = '" + username + "' ;" +
                            "var y = document.getElementsByTagName('INPUT')[43].value = '" + password + "' ;");
                }
